...
```
I'm a 2nd-year IT Security Engineering student at FST Marrakech.
Passionate about breaking things ethically and building tools that defend.
Active on HackerOne & Bugcrowd — hunting XSS, SQLi, IDOR in the wild.
CTF player with a top 6% global rank on TryHackMe.
Currently building AI-powered security tools and automation frameworks.
```
...
[✓] Threat Intelligence     — SOC Learning Path
[✓] Ransomware Defense      — Cybersecurity Training
[✓] Email Authentication Specialist 2025
```
